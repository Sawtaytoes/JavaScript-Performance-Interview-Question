...
const addNextNodeEpic = require('./addNextNodeEpic')
...
const getLargestContiguousNodesObservableConcurrent = (
	nodes,
) => {
	const rootEpic = (
		createRootEpic(
...
module.exports = getLargestContiguousNodesObservableConcurrent
